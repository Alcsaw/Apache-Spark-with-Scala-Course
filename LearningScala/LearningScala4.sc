...
// filter
val numbers = 1 to 20                             //> numbers  : scala.collection.immutable.Range.Inclusive = Range 1 to 20
val filteredNumbers = numbers.filter((x: Int) => x % 3 == 0)
                                                  //> filteredNumbers  : scala.collection.immutable.IndexedSeq[Int] = Vector(3, 6
                                                  //| , 9, 12, 15, 18)
println(filteredNumbers)                          //> Vector(3, 6, 9, 12, 15, 18)
