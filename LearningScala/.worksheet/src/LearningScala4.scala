...
// filter
val numbers = 1 to 20;System.out.println("""numbers  : scala.collection.immutable.Range.Inclusive = """ + $show(numbers ));$skip(61); 
val filteredNumbers = numbers.filter((x: Int) => x % 3 == 0);System.out.println("""filteredNumbers  : scala.collection.immutable.IndexedSeq[Int] = """ + $show(filteredNumbers ));$skip(25); 
